...
MSE.hetgpCV1 <- MSE(y.test, mean.hetgp)


y.test.hetgpCV1<- y.test
x.test.hetgpCV1<- x.test
mean.hetgpCV1<- mean.hetgp
lambda.hetgpCV1<- lambda.hetgp
...
MSE.hetgpCV2 <- MSE(y.test, mean.hetgp)


y.test.hetgpCV2<- y.test
x.test.hetgpCV2<- x.test
mean.hetgpCV2<- mean.hetgp
lambda.hetgpCV2<- lambda.hetgp
...
MSE.hetgpCV3 <- MSE(y.test, mean.hetgp)


y.test.hetgpCV3<- y.test
x.test.hetgpCV3<- x.test
mean.hetgpCV3<- mean.hetgp
lambda.hetgpCV3<- lambda.hetgp
...
MSE.hetgpCV4 <- MSE(y.test, mean.hetgp)


y.test.hetgpCV4<- y.test
x.test.hetgpCV4<- x.test
mean.hetgpCV4<- mean.hetgp
lambda.hetgpCV4<- lambda.hetgp
