...
save(pars,file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV1pars.homGP.RData")
#load(".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV1pars.homGP.RData")
...
MSE.gpCV1<- MSE(y.test,mean.gp)

y.test.gpCV1<- y.test
x.test.gpCV1<- x.test
mean.gpCV1<- mean.gp

save(mean.gpCV1, x.test.gpCV1, y.test.gpCV1, MSE.gpCV1,
     file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV1homGP_calculated_quantities.RData")
...
save(pars,file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV2pars.homGP.RData")
#load(".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV2pars.homGP.RData")
...
save(mean.gpCV2, x.test.gpCV2, y.test.gpCV2, MSE.gpCV2,
     file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV2homGP_calculated_quantities.RData")
...
save(pars,file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV3pars.homGP.RData")
#load(".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV3pars.homGP.RData")
...
MSE.gpCV3<- MSE(y.test,mean.gp)

y.test.gpCV3<- y.test
x.test.gpCV3<- x.test
mean.gpCV3<- mean.gp

save(mean.gpCV3, x.test.gpCV3, y.test.gpCV3, MSE.gpCV3,
     file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV3homGP_calculated_quantities.RData")
...
save(pars,file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV4pars.homGP.RData")
#load(".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV4pars.homGP.RData")
...
MSE.gpCV4<- MSE(y.test,mean.gp)

y.test.gpCV4<- y.test
x.test.gpCV4<- x.test
mean.gpCV4<- mean.gp

save(mean.gpCV4, x.test.gpCV4, y.test.gpCV4, MSE.gpCV4,
     file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV4homGP_calculated_quantities.RData")
...
save(pars,file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV5pars.homGP.RData")
#load(".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV5pars.homGP.RData")
...
MSE.gpCV5<- MSE(y.test,mean.gp)

y.test.gpCV5<- y.test
x.test.gpCV5<- x.test
mean.gpCV5<- mean.gp

save(mean.gpCV5, x.test.gpCV5, y.test.gpCV5, MSE.gpCV5,
     file=".../FloodingModelCalibrationProject/multires/outputData/4Pars/EuclideanDistance/hold20/prior1/10mfrom50m/CV5homGP_calculated_quantities.RData")
