flood_extent_run<-function(i){
  ...
  #river[3, 7] <- 13110.70 #flood of 2011
  river[3,7]<- 12091.29 #flood of 2004
  ...
  writeRaster(
    model_hazard,
    paste0("./Outputs10m/Extent/RunTrue2004_", i, ".asc"),
    format = "ascii",
    overwrite = T
  )
  ...
  write.csv(outputs, paste0("./Outputs10m/RunTrue2004_", i, ".csv"))
}
